...
namespace Nhom1_DeTai1.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public BrandsController(Nhom1_DeTai1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Brand != null ? 
                          ...
                          Problem("Entity set 'Nhom1_DeTai1Context.Brand'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Nhom1_DeTai1Context.Brand'  is null.");
            }
            var brand = await _context.Brand.FindAsync(id);
            if (brand != null)
            {
